...
import {Artist as DBArtist, Image as DBImage, ReferenceUnit as DBReferenceUnit} from "../../../@types/database";
...
const Group: GraphQLObjectType = new GraphQLObjectType<DBArtist, GraphQlContext>({
    name: 'Group',
    ...
    fields: () => ({
        ...
        members: {
            ...
            resolve: (root) => {
                return root.__ref.filter((item: DBReferenceUnit) => item.__contentType === 'artist/person+member');
            },
        },
        avatar: {
            name: 'avatar',
